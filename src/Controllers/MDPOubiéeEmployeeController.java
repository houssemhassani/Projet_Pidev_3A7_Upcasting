 ...
 * @author Asus
 */
public class MDPOubiéeEmployeeController implements Initializable {
    ...
    private void verifieremail(ActionEvent event) {
        ...
        String verif=mdp.motDePasseOublieeEmployee(this.cin.getText());
        if(verif!=null)
        {
        ...
        if(this.code.getText().equals(this.random.getText()))
        {
             try {
                 Alert a=new Alert(Alert.AlertType.CONFIRMATION);
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/ModifierMotDePasseEmployee.fxml"));
                    Parent root = loader.load();
                    ModifierMotDePasseEmployeeController verif=loader.getController();
