 ...
 * @author Asus
 */
public class MDPOubliéeResponsableController implements Initializable {
    ...
    private void verifieremail(ActionEvent event) {
        ...
        String verif=mdp.motDePasseOublieeResponsable(this.cin.getText());
        if(verif!=null)
        {
        ...
        if(this.code.getText().equals(this.random.getText()))
        {
             try {
                 Alert a=new Alert(Alert.AlertType.CONFIRMATION);
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/ModifierMotDePasseResponsable.fxml"));
                    Parent root = loader.load();
                    ModifierMotDePasseResponsableController verif=loader.getController();
